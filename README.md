...
- Source code for the web application built with Laravel
...
- **SASS**: Stylesheet language used for designing the web application
- **Tailwind CSS**: CSS framework used for designing the web application
- **Blade**: Templating engine used for rendering views in the application
